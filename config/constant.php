...
if (!defined('COOKING')) define('COOKING', 'cooking');
if (!defined('COMPLETED')) define('COMPLETED', 'completed');

if (!defined('ADD_WALLET_MESSAGE')) define('ADD_WALLET_MESSAGE', 'add_wallet_message');
if (!defined('ADD_WALLET_BONUS_MESSAGE')) define('ADD_WALLET_BONUS_MESSAGE', 'add_wallet_bonus_message');

if (!defined('PAYMENT_GATEWAY_IMAGE_ARRAY')) {
...
if (!defined('APPS')) define('APPS', 'apps');
...
if (!defined('DEFAULT_PAGINATION_LIMIT')) define('DEFAULT_PAGINATION_LIMIT', 10);
if (!defined('DEFAULT_PREPARATION_TIME')) define('DEFAULT_PREPARATION_TIME', 30);
if (!defined('DEFAULT_DECIMAL_POINT_SETTINGS')) define('DEFAULT_DECIMAL_POINT_SETTINGS', 2);
if (!defined('DEFAULT_MAP_API_KEY')) define('DEFAULT_MAP_API_KEY', '');
if (!defined('DEFAULT_PLAY_STORE_CONFIG')) define('DEFAULT_PLAY_STORE_CONFIG', '');
if (!defined('DEFAULT_APP_STORE_CONFIG')) define('DEFAULT_APP_STORE_CONFIG', '');
if (!defined('DEFAULT_RECAPTCHA')) define('DEFAULT_RECAPTCHA', '');
if (!defined('DEFAULT_SCHEDULE_ORDER_SLOT_DURATION')) define('DEFAULT_SCHEDULE_ORDER_SLOT_DURATION', 30);
if (!defined('DEFAULT_TIME_FORMAT')) define('DEFAULT_TIME_FORMAT', '12');
if (!defined('DEFAULT_MAIL_CONFIG')) define('DEFAULT_MAIL_CONFIG', '');
if (!defined('DEFAULT_WALLET_STATUS')) define('DEFAULT_WALLET_STATUS', 0);
if (!defined('DEFAULT_LOYALTY_POINT_STATUS')) define('DEFAULT_LOYALTY_POINT_STATUS', 0);
if (!defined('DEFAULT_REF_EARNING_STATUS')) define('DEFAULT_REF_EARNING_STATUS', 0);
if (!defined('DEFAULT_LOYALTY_POINT_EXCHANGE_RATE')) define('DEFAULT_LOYALTY_POINT_EXCHANGE_RATE', 1);
if (!defined('DEFAULT_REF_EARNING_EXCHANGE_RATE')) define('DEFAULT_REF_EARNING_EXCHANGE_RATE', 1);
if (!defined('DEFAULT_LOYALTY_POINT_ITEM_PURCHASE_POINT')) define('DEFAULT_LOYALTY_POINT_ITEM_PURCHASE_POINT', 1);
if (!defined('DEFAULT_LOYALTY_POINT_MINIMUM_POINT')) define('DEFAULT_LOYALTY_POINT_MINIMUM_POINT', 1);
if (!defined('DEFAULT_WHATSAPP')) define('DEFAULT_WHATSAPP', '');
if (!defined('DEFAULT_FAV_ICON')) define('DEFAULT_FAV_ICON', '');
if (!defined('DEFAULT_COOKIES')) define('DEFAULT_COOKIES', '');
if (!defined('DEFAULT_MAXIMUM_OTP_HIT')) define('DEFAULT_MAXIMUM_OTP_HIT', 5);
if (!defined('DEFAULT_OTP_RESEND_TIME')) define('DEFAULT_OTP_RESEND_TIME', 60);
if (!defined('DEFAULT_TEMPORARY_BLOCK_TIME')) define('DEFAULT_TEMPORARY_BLOCK_TIME', 600);
if (!defined('DEFAULT_DM_SELF_REGISTRATION')) define('DEFAULT_DM_SELF_REGISTRATION', 0);
if (!defined('DEFAULT_TOGGLE_VEG_NON_VEG')) define('DEFAULT_TOGGLE_VEG_NON_VEG', 0);
if (!defined('DEFAULT_MAXIMUM_LOGIN_HIT')) define('DEFAULT_MAXIMUM_LOGIN_HIT', 5);
if (!defined('DEFAULT_TEMPORARY_LOGIN_BLOCK_TIME')) define('DEFAULT_TEMPORARY_LOGIN_BLOCK_TIME', 600);
if (!defined('DEFAULT_RETURN_PAGE')) define('DEFAULT_RETURN_PAGE', '');
if (!defined('DEFAULT_REFUND_PAGE')) define('DEFAULT_REFUND_PAGE', '');
if (!defined('DEFAULT_CANCELLATION_PAGE')) define('DEFAULT_CANCELLATION_PAGE', '');
if (!defined('DEFAULT_OFFLINE_PAYMENT')) define('DEFAULT_OFFLINE_PAYMENT', 0);
if (!defined('DEFAULT_GUEST_CHECKOUT')) define('DEFAULT_GUEST_CHECKOUT', 0);
if (!defined('DEFAULT_PARTIAL_PAYMENT')) define('DEFAULT_PARTIAL_PAYMENT', 0);
if (!defined('DEFAULT_PARTIAL_PAYMENT_COMBINE_WITH')) define('DEFAULT_PARTIAL_PAYMENT_COMBINE_WITH', '');
if (!defined('DEFAULT_QR_CODE')) define('DEFAULT_QR_CODE', 0);
if (!defined('DEFAULT_APPLE_LOGIN')) define('DEFAULT_APPLE_LOGIN', 0);
if (!defined('DEFAULT_ADD_WALLET_MESSAGE')) define('DEFAULT_ADD_WALLET_MESSAGE', '');
if (!defined('DEFAULT_ADD_WALLET_BONUS_MESSAGE')) define('DEFAULT_ADD_WALLET_BONUS_MESSAGE', '');
if (!defined('DEFAULT_FOOTER_DESCRIPTION_TEXT')) define('DEFAULT_FOOTER_DESCRIPTION_TEXT', '');
if (!defined('DEFAULT_PUSH_NOTIFICATION_SERVICE_FILE_CONTENT')) define('DEFAULT_PUSH_NOTIFICATION_SERVICE_FILE_CONTENT', '');
if (!defined('DEFAULT_MAINTENANCE_SYSTEM_SETUP')) define('DEFAULT_MAINTENANCE_SYSTEM_SETUP', 0);
if (!defined('DEFAULT_MAINTENANCE_DURATION_SETUP')) define('DEFAULT_MAINTENANCE_DURATION_SETUP', 0);
if (!defined('DEFAULT_MAINTENANCE_MESSAGE_SETUP')) define('DEFAULT_MAINTENANCE_MESSAGE_SETUP', '');
if (!defined('DEFAULT_GOOGLE_MAP_STATUS')) define('DEFAULT_GOOGLE_MAP_STATUS', 0);
if (!defined('DEFAULT_ADMIN_ORDER_NOTIFICATION')) define('DEFAULT_ADMIN_ORDER_NOTIFICATION', 0);
if (!defined('DEFAULT_ADMIN_ORDER_NOTIFICATION_TYPE')) define('DEFAULT_ADMIN_ORDER_NOTIFICATION_TYPE', '');
if (!defined('DEFAULT_CUSTOMER_REFERRED_DISCOUNT_STATUS')) define('DEFAULT_CUSTOMER_REFERRED_DISCOUNT_STATUS', 0);
if (!defined('DEFAULT_CUSTOMER_REFERRED_DISCOUNT_TYPE')) define('DEFAULT_CUSTOMER_REFERRED_DISCOUNT_TYPE', '');
if (!defined('DEFAULT_CUSTOMER_REFERRED_DISCOUNT_AMOUNT')) define('DEFAULT_CUSTOMER_REFERRED_DISCOUNT_AMOUNT', 0);
if (!defined('DEFAULT_CUSTOMER_REFERRED_VALIDITY_TYPE')) define('DEFAULT_CUSTOMER_REFERRED_VALIDITY_TYPE', '');
if (!defined('DEFAULT_CUSTOMER_REFERRED_VALIDITY_VALUE')) define('DEFAULT_CUSTOMER_REFERRED_VALIDITY_VALUE', 0);
if (!defined('DEFAULT_REGISTER_WITH_REFERRAL_CODE_MESSAGE')) define('DEFAULT_REGISTER_WITH_REFERRAL_CODE_MESSAGE', '');
if (!defined('DEFAULT_REFERRAL_CODE_USER_FIRST_ORDER_PLACE_MESSAGE')) define('DEFAULT_REFERRAL_CODE_USER_FIRST_ORDER_PLACE_MESSAGE', '');
if (!defined('DEFAULT_REFERRAL_CODE_USER_FIRST_ORDER_DELIVERED_MESSAGE')) define('DEFAULT_REFERRAL_CODE_USER_FIRST_ORDER_DELIVERED_MESSAGE', '');