<div class="col-sm-6 col-lg-3">
    <a href="{{route('chef.orders.list',['pending'])}}" class="dashboard--card">
...
<div class="col-sm-6 col-lg-3">
    <a href="{{route('chef.orders.list',['confirmed'])}}" class="dashboard--card">
...
<div class="col-sm-6 col-lg-3">
    <a href="{{route('chef.orders.list',['processing'])}}" class="dashboard--card">
...
<div class="col-sm-6 col-lg-3">
    <a href="{{route('chef.orders.list',['out_for_delivery'])}}" class="dashboard--card">
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_pending" href="{{route('chef.orders.list',['delivered'])}}">
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_canceled" href="{{route('chef.orders.list',['canceled'])}}">
        <div class="order-stats__content">
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_returned" href="{{route('chef.orders.list',['returned'])}}">
        <div class="order-stats__content">
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_failed" href="{{route('chef.orders.list',['failed'])}}">
        <div class="order-stats__content">
