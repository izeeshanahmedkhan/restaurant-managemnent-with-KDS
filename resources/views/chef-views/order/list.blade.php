                    ...
                    <form action="{{url()->current()}}" id="form-data" method="GET">
                        <div class="row gy-3 gx-2 align-items-end">
                            ...
                            <div class="col-12 col-lg-4 d-flex gap-2">
                                <button type="reset" id="reset-filters" class="btn btn-secondary flex-grow-1">{{ translate('Clear') }}</button>
            ...
            <div class="px-4 mt-4">
                <div class="row g-2">
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{route('chef.orders.list', ['status' => 'pending'])}}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                    <img src="{{asset('assets/admin/img/icons/pending.png')}}" alt="dashboard" class="oder--card-icon">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{route('chef.orders.list', ['status' => 'confirmed'])}}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{route('chef.orders.list', ['status' => 'processing'])}}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                    <img src="{{asset('assets/admin/img/icons/packaging.png')}}" alt="dashboard" class="oder--card-icon">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{route('chef.orders.list', ['status' => 'out_for_delivery'])}}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{route('chef.orders.list', ['status' => 'delivered'])}}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                    <img src="{{asset('assets/admin/img/icons/delivered.png')}}" alt="dashboard" class="oder--card-icon">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{route('chef.orders.list', ['status' => 'canceled'])}}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{route('chef.orders.list', ['status' => 'returned'])}}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                ...
                                <span class="card-title text-warning">
                                    {{$orderCount['returned'] ?? 0}}
                            </span>
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100" href="{{route('chef.orders.list', ['status' => 'failed'])}}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                    ...
                    <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                        ...
                        @foreach($orders as $key=>$order)
                            ...
                            <tr class="status-{{$order['order_status']}} class-all">
                                ...
                                <td>
                                    <a class="text-dark" href="{{route('chef.orders.details',['id'=>$order['id']])}}">{{$order['id']}}</a>
                                </td>
                                <td>
                                    <div>
                                    ...
                                    @if($order->is_guest == 0)
                                        @if($order->customer)
                                            <a class="text-dark text-capitalize"
                                               href="{{route('chef.orders.details',['id'=>$order['id']])}}">{{$order->customer['f_name'].' '.$order->customer['l_name']}}</a>
                                        @else
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        href="{{route('chef.orders.details',['id'=>$order['id']])}}"><i
    ...
    (function(){
        ...
        if(resetBtn){
            resetBtn.addEventListener('click', function(e){
                e.preventDefault();
                // Navigate to the base URL without any query params to fully reset filters
