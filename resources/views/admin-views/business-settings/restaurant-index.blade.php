                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center mt-3">
                                    <img style="height: 100px;border: 1px solid; border-radius: 10px;" id="viewer"
                                         ...
                                         src="{{asset('storage/app/restaurant/'.$logo)}}" alt="logo image"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center mt-3">
                                    <img style="height: 100px;border: 1px solid; border-radius: 10px;" id="viewer_2"
                                         onerror="this.src='{{asset('assets/admin/img/160x160/img2.jpg')}}'"
                                         src="{{asset('storage/app/restaurant/'.$fav_icon)}}" alt="fav"/>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                ...
                                <label class="switcher">
                                    <input name="halal_tag_status"
                                        ...
                                        data-image="{{ asset('assets/admin/img/halal-tags.png') }}"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('admin.business-settings.restaurant.maintenance-mode-setup')}}" id="maintenance_system_setup_Form">
                        <?php
                        $selectedMaintenanceSystem = \App\CentralLogics\Helpers::get_business_settings('maintenance_system_setup');
                        $selectedMaintenanceDuration = \App\CentralLogics\Helpers::get_business_settings('maintenance_duration_setup');
                    ...
                    <div class="modal-footer">
                        <div class="btn--container justify-content-end">
                            <button type="button" form="maintenance_system_setup_Form" class="btn btn-secondary" data-dismiss="modal" id="cancelButton">{{ translate('Cancel') }}</button>
                            <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}" form="maintenance_system_setup_Form" class="btn btn-primary call-demo">{{ translate('Save') }}</button>
                        </div>
                    </div>
            </div>
        </div>
            ...
            $(document).ready(function() {
                ...
                function updateDatesBasedOnDuration(selectedOption) {
                    if (selectedOption === 'one_day' || selectedOption === 'one_week') {
                        ...
                        $('.start-and-end-date').removeClass('d-none');
                        dateError.hide();
                        ...
                        $('.start-and-end-date').addClass('d-none');
                        dateError.hide();
