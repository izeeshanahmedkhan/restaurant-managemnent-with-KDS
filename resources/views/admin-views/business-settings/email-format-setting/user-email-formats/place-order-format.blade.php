    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                ...
                @php($template=$template??($data?$data->email_template:3))
                                    ...
                                    <div>
                                        ...
                                        <div class="d-flex justify-content-center mt-4">
                                            <div class="upload-file">
                                                <input type="file" id="mail-logo" name="logo" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*" class="upload-file__input">
                                                <div class="upload-file__img_drag upload-file__img">
                                                    <img width="465" id="viewer"
                                                         src="{{isset($data) && $data['logo'] ? asset('storage/app/email_template/'.$data['logo']) : asset('assets/admin/img/icons/upload_img2.png')}}"
