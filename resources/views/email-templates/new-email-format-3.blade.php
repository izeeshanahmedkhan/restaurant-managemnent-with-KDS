                        ...
                        <tr>
                            <td class="p-10">
                                    <span class="d-block text-center">
                                        ...
                                        <img class="mb-2 mail-img-2" onerror="this.src='{{ asset('storage/app/restaurant/' . $restaurant_logo) }}'"
                                                ...
                                                <td colspan="6">
                                                    ...
                                                    <table class="w-100">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right p-1 px-3">{{ \App\CentralLogics\Helpers::set_symbol($order['referral_discount']) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 40%"></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right p-1 px-3">
                                                                <span class="text-base">{{ \App\CentralLogics\Helpers::set_symbol($sub_total + $total_tax + $add_ons_cost - $total_dis_on_pro + $add_ons_tax_cost - $order['coupon_discount_amount'] - $order['extra_discount'] - $order['referral_discount'] + $del_c) }}</span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
